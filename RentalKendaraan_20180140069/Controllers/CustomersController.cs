...
namespace RentalKendaraan_20180140069.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdCostumer,NamaCustomer,Nik,Alamat,NoHp,IdGender")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCostumer,NamaCustomer,Nik,Alamat,NoHp,IdGender")] Customer customer)
        {
        ...
        {
            return _context.Customer.Any(e => e.IdCostumer == id);
        }
    }
}
